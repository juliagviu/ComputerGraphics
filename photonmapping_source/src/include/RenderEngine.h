...
public:
	...
	/** Build engine from world information, a Film and a camera. */
 	RenderEngine(World*  _world, Random* random, Film* _film, Camera* _camera, PhotonMapping *_pm):
 		world(_world), film(_film), camera(_camera), photon_mapping(_pm), random(random)
	{
